...
2. Guardar capítulo, idiomas, intención y glosario. No hay un corte de traducción a 12.000 caracteres: se conserva el documento completo, hasta el límite técnico de almacenamiento de 1 MB UTF-8. Las fuentes de apoyo seleccionadas sirven como contexto. Cambiar de capítulo y marcarlo es explícito; los proyectos ya divididos conservan sus unidades. La capacidad de entrada y salida depende del modelo: para unidades que la excedan, elegí fragmentos editoriales menores.
