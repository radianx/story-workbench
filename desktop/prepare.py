...
def main():
    ...
    if target == 'linux':
        ...
        server.mkdir()
        for name in ('app.py','workbench_ai.py','workbench_account.py','workbench_store.py','workbench_production.py','workbench_export.py','workbench_voice.py','workbench_modes.py','workbench_realtime.py'):
