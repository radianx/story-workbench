...
async function navigateWorkbench(target){
  ...
  if(target==='back'){
    if(!modal)return;
    const closers={'team-settings':'team-close','image-viewer':'image-viewer-close','images-dialog':'images-close','settings-dialog':'settings-close','help-dialog':'help-close','account-dialog':'account-close','realtime-dialog':'realtime-close','engine-dialog':'engine-close','navigation-dialog':'navigation-close','setup-dialog':'setup-skip'};
